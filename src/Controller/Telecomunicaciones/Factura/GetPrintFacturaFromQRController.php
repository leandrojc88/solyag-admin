...
class GetPrintFacturaFromQRController extends AbstractController
{
    /**
     * @Route("/telecomunicaciones/factura/print-facturas-qr/{factura}", name="tele_get_print_facturas_qr")
     */
