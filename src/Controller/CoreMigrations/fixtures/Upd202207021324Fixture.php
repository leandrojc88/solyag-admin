...
class Upd202207021324Fixture extends AbstratFixture
{
    ...
    public function up(): void
    {
        ...
        // subcuenta
        $this->addSql("INSERT INTO `subcuenta` (`id_cuenta_id`, `nro_subcuenta`, `elemento_gasto`, `descripcion`, `deudora`, `activo`, `bloqueado`) VALUES( 151, '0000', 0, 'Compra de servicios no programados', 1, 1, NULL);");
        $this->addSql("INSERT INTO `subcuenta` (`id_cuenta_id`, `nro_subcuenta`, `elemento_gasto`, `descripcion`, `deudora`, `activo`, `bloqueado`) VALUES( 83, '0000', 0, 'Venta de servicios no programados', 0, 1, NULL);");
    }
}
